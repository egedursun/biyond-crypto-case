...
class HyperParameters:
    class Fund:
        ...
        transaction_volume = 60  # N of shares per transaction
        trade_frequency = 1  # Every N days
        gpt_trade_frequency = 15  # Every N days for GPT requests

        transaction_cost = 0.0005  # N% of the transaction volume
        ...
        transaction_volume_maximum = 120  # max N of shares per transaction
