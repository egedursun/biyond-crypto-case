from strategy.clients.GPTClient import GPTClient
...
class GPT_4LongShortStrategy:
    ...
    def __init__(self):
        ...
        self.gpt_client.build_assistant(name="biyond-stock-gpt4",
                                        instructions=GPT_PROMPT,
                                        model="gpt-4",
                                        max_tokens=5,
                                        temperature=0.5)
        self.assistant = self.gpt_client.get_assistant(name="biyond-stock-gpt4")
